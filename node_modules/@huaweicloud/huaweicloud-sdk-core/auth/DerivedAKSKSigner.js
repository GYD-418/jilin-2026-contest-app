...
class DerivedAKSKSigner extends AKSKSigner_1.AKSKSigner {
    static sign(request, credential) {
        ...
        const canonicalURI = this.CanonicalURI((_b = parsedUrl.pathname) !== null && _b !== void 0 ? _b : '');
        ...
        const derivationKey = (_c = HKDF_1.HKDF.getDerKeySHA256(credential.getAk(), credential.getSk(), info)) !== null && _c !== void 0 ? _c : '';
