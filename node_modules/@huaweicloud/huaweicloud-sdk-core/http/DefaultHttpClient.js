...
class DefaultHttpClient {
    ...
    _createAxiosInstance() {
        const proxyAgent = this._defaultOptions.proxy ? (0, https_proxy_agent_1.default)(this._defaultOptions.proxy) : undefined;
